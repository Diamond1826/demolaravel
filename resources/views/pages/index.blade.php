...
<div class="row">
    <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 col-sm-offset-1 col-md-offset-1 col-lg-offset-1">
	   <p class="text-center rowborder he">Herzlich Willkommen auf meiner Homepage</p> 
    </div>
  </div>
  <div class="row">
    <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
      <img class="img-responsive img-thumbnail" src="{{ asset('img/bild1.jpg') }}" alt="boring">
      <div class="caption text-center colborder">
